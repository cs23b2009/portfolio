...
const getDurationText = (
  ...
  const start = getMonthYearFromDate(startDate);
  const end =
...
const ExperienceCard: React.FC<ExperienceCardProps> = ({ experience }) => {
  return (
    <div className="group relative overflow-hidden rounded-lg border bg-background p-4 sm:p-6 transition-all duration-300 hover:shadow-md hover:border-primary/50">
